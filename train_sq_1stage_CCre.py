...
dir_name = './log/C4_sq_1stage_CCre'     # 20220423  _CCre
...
#load data
dataset_train = ColorCheckerRE(train=True,folds_num=opt.foldnum)   # ColorChecker
...
dataset_test = ColorCheckerRE(train=False,folds_num=opt.foldnum) # ColorChecker
