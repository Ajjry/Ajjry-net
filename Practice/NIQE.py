...
if __name__ == '__main__':
    ...
    scor_enhace=0
    for i in range(12):
        im=cv2.imread('F:/eyes/349/%d/input.png'%(int(i)))
        enhace=cv2.imread('F:/eyes/349/%d/0.png'%(int(i)))
        score_im=niqe(im)
        score_enhace = niqe(enhace)
        scor_im+=score_im
        scor_enhace+=score_enhace
    print('img:',scor_im/12)
    print('enhance_img:' , scor_enhace / 12)