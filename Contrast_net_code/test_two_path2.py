...
def lowlight(image_path,config):
    ...
    result_path=image_path.replace('raw-890','result')
...
if __name__ == '__main__':
    with torch.no_grad():
        ...
        parser.add_argument('--test_path', type=str, default="/home/cc/CODE/Dehazing_net_code/data/test/raw-890/")
        ...
        parser.add_argument('--snapshots_pth', type=str, default="/home/cc/CODE/Contrast_net_code/snapshots2")
